...
export const MissionSection: React.FC = () => {
  return (
    <div className="flex flex-col h-full bg-[#FCF8F2] border border-[#EAE1D8] rounded-[2rem] p-6 md:p-8 lg:p-10 items-center text-center w-full">
      <motion.div
      ...
      >
        ...
        <div className="flex items-end justify-center gap-2 mb-10">
          ...
          <span className="text-3xl xl:text-4xl tracking-wide text-[#C99547] font-serif">Textile to Landfill</span>
        </div>
        ...
        <div className="w-full flex flex-col gap-8">
          ...
          <div className="relative flex flex-col items-center gap-3 w-full">
            ...
            <div className="relative z-10 bg-[#FCF8F2] border border-[#A77E50] text-[#4A3D30] px-6 py-2.5 rounded-full font-bold text-md min-w-50">
              Tukar Pakaian
            </div>
